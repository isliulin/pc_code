...
QString TableItem::getItemName()
{
    return QObject::tr("表格");
}

int TableItem::GroupType()
{
    return SAM_DRAW_GROUP_TABLE;
}

QGraphicsItem *TableItem::Clone()
{
    QGraphicsItem *pCopy = NULL;
    QGraphicsItem * pItem= NULL;

    TableItem *itemGroup = new TableItem();
...
void TableItem::compile(QSqlDatabase &db, int nSceneId,int &count,int index)
{

}

void TableItem::save(QDataStream &stream)
{
    QVisableItem::save(stream);

}

void TableItem::load(QDataStream &stream)
{
